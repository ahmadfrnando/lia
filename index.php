...
//fungsi fitur kirim email
        ...
        // More headers
        $headers .= 'From: <pendamankomputer.com>' . "\r\n";
        $headers .= 'Cc: pendamankomputer.com' . "\r\n";
        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                <div class="navbar-header">
                    ...
                    <a href="#" class="navbar-brand scroll-top" style="color: black !important;"><?php echo "$showprofile[titlewebsite]"; ?></a>
                </div>
                <!--/.navbar-header-->
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="./confpanel/index.php" class="scroll-link" >LOGIN</a></li>
                    </ul>
                </div>
                <!--/.navbar-collapse-->
            </nav>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="logo">
                      ...
                      | Theme by : <span>Pendaman Bohalima</span></p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="location">
