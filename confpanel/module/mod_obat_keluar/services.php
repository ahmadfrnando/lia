           ...
           <div class=\"row mt\">
            <div class=\"col-md-12\">
             ...
             <div class=\"panel-body\">
                 <a href=\"./laporan-barang-keluar.php\" class=\"btn btn-primary\" target=\"_blank\"><i class=\"fa fa-download\"></i> Download PDF</a>
               </div>
              <table class=\"table table-striped table-advance table-hover\">
                <h4>[ <i class=\"fa fa-info\"> ]</i> Tabel Obat Keluar</h4>
                <hr>
                  <thead>
                  <tr>
                    <th><i class=\"\"></i> No</th>
