 ...
 <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="template.php" class="logo"><b>Toko Obat | Admin Panel</b></a>
            <!--logo end-->
                  ...
                  <li class="sub-menu">
                    ...
                    ?>
                      ...
                      if ($module=="obatmasuk"){
                           ...
                           echo"<li><a href=\"module/mod_obat_masuk/services.php?tbl=obatmasuk\">Tabel Obat Masuk</a></li>";
                      }
                      ...
                      if ($module=="obatkeluar"){
                           ...
                           echo"<li><a href=\"module/mod_obat_keluar/services.php?tbl=obatkeluar\">Tabel Obat Keluar</a></li>";
                      }
